...
class BusinessSearch:
    ...
    def _parse_results(self, data):
        ...
        "review_count": data['review_count'], "categories": categories, "rating": data['rating'], "latitude": latitude, "longitude": longitude, 
        "price": data['price'], "location": location, "display_phone": data['display_phone']}
