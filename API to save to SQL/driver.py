...
parser = argparse.ArgumentParser(
    description="An example of Yelp business finder based on parameters, such as name, location, price, etc."
...
def main():
    ...
    # Encoding price levels to filter the search result with: 1 = $, 2 = $$, 3 = $$$, 4 = $$$$.
...
if __name__ == "__main__":
    ...
    required.add_argument("-t", "--term", metavar='', required=True, help="Enter search term, for example \"food\" or \"restaurants\". The term may also be business names, such as \"Starbucks.\".")
